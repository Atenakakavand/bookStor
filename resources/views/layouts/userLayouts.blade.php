    ...
    <div id="right">
        ...
        <ul id="menu" class="collapse">
            ...
            <li class="panel active">
                <a href="index.html" >
                    <i class="icon-table"></i>پنل کاربری
            ...
            <li class="panel ">
                <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                    <i class="icon-tasks"> </i>پروفایل
                </a>
                <ul class="collapse" id="component-nav">

                    <li class="">
                       <li><a href="{{route('profile.create')}}"><i class="icon-angle-left"></i>افزودن اطلاعات پروفایل </a></li>
                    <li><a href="{{route('profile.index')}}"><i class="icon-angle-left"></i>اطلاعات پروفایل </a></li>
